  ...
  useEffect(() => {
    if (session) {
      const fetchData = async () => {
        try {
          const response = await fetch(`/api/data-distributor?userId=${session.user.id}`)
...
export default TabelDistributor
